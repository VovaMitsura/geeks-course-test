...
class EquationEvaluatorUtilTest {
    ...
    private static Stream<Arguments> validEquationAndRoots() {
        return Stream.of(
                ...
                Arguments.of("2*x * (-5 + ( 1 * (5 + 5))) = 10", 1d),
                Arguments.of("2*x * (-5 + ( 1 * (5 / 5))) = 10", -5/4d),
                Arguments.of("2*x * (-5 + ( 1 * (5 - 4))) = 10", -5/4d),
                Arguments.of("2*x * (-5 - 5) = 10", -1/2d),
                Arguments.of("2*x = -1/2", -1/4d),
                Arguments.of("5- (x * ( 6 / 2) + 3) = 2", 0d),
                Arguments.of("(3 / (2 + x) * 4) - -6 = 7.875", 4.4d),
